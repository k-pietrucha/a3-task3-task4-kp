...
urchins_data %>%
  ...
  summarize("Mean" = round(mean(size), 1),
            ...
            "Sample Size" = n()) %>%
  kbl(caption = "<center>Summary statistics for purple and red urchin diameters</center>", col.names = c("Species", "Mean (cm)", "Median (cm)", "Standard Deviation (cm)", "Sample Size")) %>%
...
```{r, fig.cap="**Figure 1.2:** Purple urchin populations at 5 Santa Barbara-area sampling sites (2008-2020)"}
purple_urchin_table %>%
